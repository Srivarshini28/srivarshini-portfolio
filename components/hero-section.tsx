...
export default function HeroSection() {
  return (
    <section id="home" className="py-40 animate-fadeIn">
      <div className="flex flex-col items-start space-y-4">
        ...
        <h3 className="text-3xl font-medium text-gray-400 md:text-4xl">MCA graduate</h3>
        <p className="max-w-2xl py-4 text-gray-300">
          Motivated MCA graduate eager to apply academic knowledge and collaborate within a dynamic team to drive
